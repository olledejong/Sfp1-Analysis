...
### IMPORTANT PATHS ###
#######################
data_dir = "C:/Users/Olle de Jong/Documents/MSc Biology/MSB Research/VolumeAnalysisData/"
tiff_files_dir = f"{data_dir}/Input/processed_tiffs_nup133/"  # relative path from data directory to tiff directory
output_dir = f"{data_dir}Output/"  # relative path from data directory to image output directory
budj_data_folder = f"{data_dir}Input/BudJ/"  # folder that holds the BudJ info on all cells
budding_data_path = f"{data_dir}Input/buddings.txt"  # budding events
kario_data_path = f"{data_dir}Input/kariokinesis.txt"  # kariokynesis events
